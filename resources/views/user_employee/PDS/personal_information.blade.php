                  ...
                  <div class="card-body">
                    ...
                    <form class="">
                      ...
                      <div class="form-group">
                        ...
                        <p class="form control form-control-sm border">{{$account_info->fname}}</p>
                      </div>
                      <div class="row">
                        <div class="form-group col-7" >
                          <label >Middle Name </label>
                          <p class="form control form-control-sm border">{{$account_info->mname}}</p>
                        </div>
                        <div class="form-group col-5">
                          <label >Extension </label>
                          <p class="form control form-control-sm border">{{$account_info->lname}}</p>
                        </div>  
