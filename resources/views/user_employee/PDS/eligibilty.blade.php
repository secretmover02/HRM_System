                ...
                <div class="card">
                  <div class="card-body" >
                    <h4 class="card-title"> Licenses
                      <a href="" class="ml-4 btn btn-sm btn-primary" style="float:right;"><span class="fa fa-plus mr-1"> </span> <span class="update_label">Add</span></a>
                      </h4>
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-12 col-xs-12">
                          <div class="card border mt-5" style=" border-radius: 5px;">
                            ...
                            <div class="card-body row">
                              ...
                              <div class="col-8">
                                <p><strong>{{$csc->license_title}} </strong></p>
                              </div>
                              <div class="col-4">
                                <p>Rating :  </p>
                              </div>
                              <div class="col-8">
                                <p><strong>{{$csc->rating}} </strong></p>
                              </div>
                              <div class="col-4">
                                <p>Exam Date :  </p>
                              </div>
                              <div class="col-8">
                                <p><strong>{{$csc->date_examination}} </strong></p>
                              </div>
                              <div class="col-4">
                                <p>Place :  </p>
                              </div>
                              <div class="col-8">
                                <p><strong>{{$csc->place_examination}} </strong></p>
                              </div>
                              <div class="col-4">
                                <p>Number :  </p>
                              </div>
                              <div class="col-8">
                                <p><strong>{{$csc->license_number}} </strong></p>
                              </div>
                              <div class="col-4">
                                <p>Validity :  </p>
                              </div>
                              <div class="col-8">
                                <p><strong>{{$csc->date_validity}} </strong></p>
                              </div>
